...
{
    /// <summary>
    /// Response DTO for getting queue list by doctor ID.
    /// </summary>
    public class GetQueueListByIdResponse
    {
        ...
        public List<QueueByIdItemDto> Items { get; set; } = new();
    }

    /// <summary>
    /// DTO representing a queue item for specific doctor.
    /// </summary>
    public class QueueByIdItemDto
    {
