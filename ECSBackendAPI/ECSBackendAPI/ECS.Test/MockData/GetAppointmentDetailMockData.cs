...
{
    public static class GetAppointmentDetailMockData
    {
        ...
        public static GetAppointmentDetailRequest GetValidRequest(Guid? appointmentId = null)
            ...
            DateTime? createdAt = null)
        {
            return new Appointment
            {
                ...
                AppointmentDate = appointmentDate ?? new DateTime(2025, 1, 1),
                CreatedAt = createdAt ?? new DateTime(2025, 1, 1, 7, 0, 0),
                Status = status,
                Symptoms = "Mờ mắt",
            ...
            Feedback? feedback = null)
        {
            ...
            appointment.Patient = GetPatientProfile(patientId, createdById ?? ValidUserId);
            appointment.Doctor = GetDoctorProfile(doctorId, clinicId, createdById ?? ValidUserId);
            appointment.Slot = GetTimeSlot(slotId);
            appointment.Service = GetService(serviceId);
            appointment.Feedback = feedback ?? GetFeedback();
