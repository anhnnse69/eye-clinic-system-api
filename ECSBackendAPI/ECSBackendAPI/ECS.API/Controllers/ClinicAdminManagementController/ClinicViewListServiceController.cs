...
namespace ECS.API.Controllers.ClinicAdminManagementController
{
    ...
    public class ClinicViewListServiceController : ControllerBase
    {
        ...
        public ClinicViewListServiceController(IViewClinicServicesService viewClinicServicesService)
        {
