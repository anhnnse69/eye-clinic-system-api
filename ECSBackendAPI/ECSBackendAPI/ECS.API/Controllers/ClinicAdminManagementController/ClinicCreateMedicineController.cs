...
namespace ECS.API.Controllers.ClinicAdminManagementController
{
    ...
    public class ClinicCreateMedicineController : ControllerBase
    {
        ...
        public ClinicCreateMedicineController(ICreateMedicineCatalogService createMedicineCatalogService)
        {
