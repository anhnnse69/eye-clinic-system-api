...
namespace ECS.API.Controllers.ClinicAdminManagementController
{
    ...
    public class ClinicDeleteMedicineCatalogController : ControllerBase
    {
        private readonly IDeleteMedicineCatalogService _deleteMedicineCatalogService;

        /// <summary>
        /// Initializes a new instance of <see cref="ClinicDeleteMedicineCatalogController"/> with business layers.
        /// </summary>
        /// <param name="deleteMedicineCatalogService">The application workflow service engine executor interface.</param>
        public ClinicDeleteMedicineCatalogController(IDeleteMedicineCatalogService deleteMedicineCatalogService)
        {
